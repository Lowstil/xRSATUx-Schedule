...
private Constants() { }
/** ЗАПАСНАЯ прямая ссылка. Основной путь — поиск ссылки на файл по имени
 *  на странице SCHEDULE_PAGE_URL (имя файла на сайте меняется, жёсткая
 *  ссылка устаревает мгновенно). Если знаете актуальную прямую ссылку —
 *  держите её здесь, она используется, когда поиск по странице не удался. */
public static final String SCHEDULE_URL =
"https://university.ru/schedule/Raspisanie-zanyatiy.xlsx";
/** Страница, на которой размещён текущий файл расписания. */
public static final String SCHEDULE_PAGE_URL =
"https://www.rsatu.ru/students/raspisanie-zanyatiy/";
/** Фрагмент имени файла расписания (без учёта регистра) для поиска на странице. */
...
* (см. TRANSFERS_FILENAME_HINT), и уже её скачивает.
*/
public static final String TRANSFERS_PAGE_URL =
"https://www.rsatu.ru/students/raspisanie-zanyatiy/";
/** Резервная прямая ссылка — используется, ТОЛЬКО если поиска по странице
*  не удался И кэша переносов нет (иначе остаёмся на ранее загруженных). */
